...
__maybe_unused static void *cnss_create_ramdump_device(struct cnss_plat_data *plat_priv)
{
...
__maybe_unused static void cnss_destroy_ramdump_device(struct cnss_plat_data *plat_priv,
					void *ramdump_dev)
{
